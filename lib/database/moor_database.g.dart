...
class Book extends DataClass implements Insertable<Book> {
  ...
  factory Book.fromJson(Map<String, dynamic> json,
    ...
    return Book(
      ...
      reviewAverage: serializer.fromJson<double>(json['reviewAverage']),
  ...
  Map<String, dynamic> toJson({ValueSerializer serializer}) {
    ...
    return <String, dynamic>{
      ...
      'reviewAverage': serializer.toJson<double>(reviewAverage),
                                                                  ...
                                                                  $mrjc(
                                                                      ...
                                                                      $mrjc(
                                                                          ...
                                                                          $mrjc(
                                                                              ...
                                                                              $mrjc(myRate.hashCode, $mrjc(tags.hashCode, $mrjc(status.hashCode, readNum.hashCode)))))))))))))))))))))));
  @override
...
class BooksCompanion extends UpdateCompanion<Book> {
  ...
  final Value<double> reviewAverage;
...
class $BooksTable extends Books with TableInfo<$BooksTable, Book> {
  ...
  GeneratedRealColumn _reviewAverage;
  @override
  GeneratedRealColumn get reviewAverage =>
      _reviewAverage ??= _constructReviewAverage();
  GeneratedRealColumn _constructReviewAverage() {
    return GeneratedRealColumn('review_average', $tableName, false,
  ...
  Map<String, Variable> entityToSql(BooksCompanion d) {
    ...
    if (d.reviewAverage.present) {
      map['review_average'] = Variable<double, RealType>(d.reviewAverage.value);
    }
    if (d.hasRead.present) {
